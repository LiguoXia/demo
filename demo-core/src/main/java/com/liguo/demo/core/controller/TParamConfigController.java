...
public class TParamConfigController {
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    public HttpResult save(@ApiParam("资金计划业务控制对象") @RequestBody TParamConfig tParamConfig) {
    ...
    public HttpResult delete(@ApiParam("资金计划业务控制对象") @RequestParam Long id) {
        log.info("请求参数:{}", id);
        try {
    ...
    @ApiOperation("更新")
    @PostMapping("/updat")
    public HttpResult updat(@ApiParam("资金计划业务控制对象") @RequestBody TParamConfig tParamConfig) {
        log.info("请求参数:{}", tParamConfig.toString());
        try {
    ...
    @ApiOperation("查询")
    @PostMapping("/query")
    public HttpResult query(@ApiParam("键值") @RequestParam String key) {
        log.info("请求参数:{}", key);
        ...
        return HttpResult.success(itParamConfigService.getOne(lambdaQueryWrapper));
    }
}
