 ...
 */
@Slf4j
public class ThreeFlowExcelDataListener extends AnalysisEventListener<ThreeFlow> {
    /**
     ...
     * Excel解析对象集合
     */
    List<ThreeFlow> list = new ArrayList<>();
     ...
     * 构造函数,实现类传参
     *
     * @param threeFlowService 经营类资金计划明细表 服务实现类
     */
    public ThreeFlowExcelDataListener(IThreeFlowService threeFlowService) {
        this.threeFlowService = threeFlowService;
    }
     ...
     */
    @Override
    public void invoke(ThreeFlow data, AnalysisContext context) {
    ...
    private void saveData() {
        ...
        threeFlowService.importDate(list);
        log.info("存储数据库成功!");
    }
}
